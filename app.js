	...
	csp({
	  directives: {
		...
		"script-src": [`'nonce-${res.locals.nonce}'`,
						...
						"https://scripts.sirv.com/sirvjs/v3/components/zoominstance.js",
						"https://scripts.sirv.com/sirvjs/v3/components/hint.js",
						"https://scripts.sirv.com/sirvjs/v3/components/progressloader.js",
						"https://scripts.sirv.com/sirvjs/v3/components/spin.js",
						"https://scripts.sirv.com/sirvjs/v3/components/video.js",
						"https://scripts.sirv.com/sirvjs/v3/components/zoom.js",
						"https://scripts.sirv.com/sirvjs/v3/components/imagezoom.js",
					"http://localhost:3000/"],
		"object-src" : ["'none'"],
		"base-uri" : ["'self'"]
		}
